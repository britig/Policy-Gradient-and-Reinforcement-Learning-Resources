...
from Box2D import *
from eval_policy import eval_policy, collect_batches
#Update failure network
from UpdateNetworkPerTrajectory import correct_policy
#from bo import BO
...
class PPO:
	...
	def __init__(self, env, **hyperparameters):
		...
		self.act_dim = env.action_space.n #env.action_space.shape[0]

		 # Initialize actor and critic networks
		self.actor = FeedForwardActorNN(self.obs_dim, self.act_dim) 
	...
	def learn(self, total_timesteps,env_name):
		"""
...
def test(env, actor_model, critic_model):
	...
	critic = FeedForwardCriticNN(obs_dim, 1)
...
if __name__ == '__main__':
	...
	#Specify the environment for training
	seed = 0
	env.seed(seed)
	model = PPO(env=env, **hyperparameters)
	model.learn(200000000,'CartPole-v0')'''
	#=============================== Training Code End ================================#
	#=============================== Policy Testing Code Start ==========================#
	test(env,'ppo_actorCartPole-v0.pth','ppo_criticCartPole-v0.pth')
	#=============================== Policy Testing Code End ============================#
	#=============================== Computing Failure Trajectories Code Start ==========================#
	
	#=============================== Computing Failure Trajectories Code Start  ==========================#
	#env = gym.make('LunarLanderContinuous-v2')
	#dummy bounds for testing
	#bounds = [{'name': 'y_pos', 'type': 'continuous', 'domain': (15,20)}]
